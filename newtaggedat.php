...
$subs=1;
$query = "SELECT text, username, locationtag
...
//print the results
if($subs==0){
	print "<h1>Tweets from $locationtag:</h1><br>";
}else{
	print "<h1>Tweets from $locationtag (or a subtag of $locationtag):</h1><br>";
}
